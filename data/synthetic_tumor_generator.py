...
class FewShotEpisodeSampler:
    """Sample episodes for few-shot meta-learning"""
    
    def __init__(self, base_dataset, k_shot=5, n_query=10):
        self.base_dataset = base_dataset
        self.k_shot = k_shot
        self.n_query = n_query
        
    def sample_episode(self):
        """Sample one meta-learning episode"""
        n = len(self.base_dataset)
        
        total_needed = self.k_shot + self.n_query
        indices = random.sample(range(n), min(total_needed, n))
